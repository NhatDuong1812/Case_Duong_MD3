...
<%--	<div class="btn-group">--%>
<%--		<button type="button" class="btn btn-secondary dropdown-toggle" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">--%>
<%--			Dropdown button--%>
<%--		</button>--%>
<%--		<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">--%>
<%--			<li><a class="dropdown-item" href="Controller?page=mobiles">Action</a></li>--%>
<%--			<li><a class="dropdown-item" href="Controller?page=laptops">Another action</a></li>--%>
<%--			<li><a class="dropdown-item" href="Controller?page=clothing">Something else here</a></li>--%>
<%--		</ul>--%>
<%--	</div>--%>
