...
<form method="post" action="admin?action=addProduct">
    ...
    <div class="signup-group">
        ...
        <input type="text" name="category" placeholder="loại" required>
    </div>
    ...
    <div class="signup-group">
        <%--@declare id="fileupload"--%><label>Image</label>
            <input type="text" name="image" placeholder="link.img" required>
    </div>
    <div class="signup-group">
