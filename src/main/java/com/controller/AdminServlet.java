    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(page.equals("admin-login-form")) {
            ...
            if(username.equals("admin") && password.equals("admin@1234")) {
                request.getRequestDispatcher("/WebContent/admin/index.jsp").forward(request, response);
            }
            else {
                request.setAttribute("msg", "Invalid Crediantials");
                request.setAttribute("username", username);
                request.getRequestDispatcher("/WebContent/admin/login.jsp").forward(request, response);
        ...
        if(page.equals("addproduct")) {
            request.getRequestDispatcher("/WebContent/admin/addProduct.jsp").forward(request, response);
        }
        ...
        if(page.equals("edit")) {
            ...
            request.getRequestDispatcher("/WebContent/admin/editProduct.jsp").forward(request, response);
        }
